...
let testTrustDynamics = function() {
  ...
  let state0 = sample(transitionFn(state, 0))
  let state1 = sample(transitionFn(state, 1))
  let state2 = sample(transitionFn(state, 2))
  let state3 = sample(transitionFn(state, 3))
  let state4 = sample(transitionFn(state, 4))

...
let readPlays = function(lines) {
  ...
  let processPlaysLine = function(acc, line) {
    ...
    let actions = map(function(actionRaw) {
...
let processData = function(data, csmg, playersPrior) {
  info("processData()")
  assertDefined(data, "processData(): data undefined")
  assertDefined(csmg, "processData(): csmg undefined")
  assertDefined(playersPrior, "processData(): playersPrior undefined")
  ...
  let processOnePlay = function(playersDataStructure, play) {
    ...
    assertDefined(playersDataStructure,
      "processOnePlay(): playersDataStructure undefined")
    assertDefined(play, "processOnePlay(): play undefined")
    ...
    let processRound = function(prior, roundData) {
      ...
      assertDefined(prior, "processRound(): prior undefined")
      assertDefined(roundData, "processRound(): actions undefined")

      let states = assertDefined(roundData.states,
        "processRound(): states undefined")
      let actions = assertDefined(roundData.actions,
      ...
      let processAction = function(prior, stateAction) {
        assertDefined(prior, "processAction(): prior undefined")
        assertDefined(stateAction, "processAction(): stateAction undefined")
        info("processAction(): stateAction=" + toString(stateAction))
        let state = assertDefined(stateAction.state,
          "processAction(): state undefined")
        let observedAction = assertDefined(stateAction.action,

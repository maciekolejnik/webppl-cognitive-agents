...
let makeCSMG = function(gameSpecificParams) {
    ...
    /** transition function can be probabilistic */
    ...
    let physicalRewardStructure = function() {
        ...
        return {
            actionRewards,
            stateRewards,
            quantity: 0 // put here the number of physical rewards
        }
    }()
    ...
    let mentalStateDynamics = function() {
         ...
         */
        let updateMentalAttitude1Estimation = function(trust, estimatingAgent, estimatedAgent, state, action) {
            error("not implemented")
        }
        ...
        let computeMentalAttitude1 = function(state, belief) {
            error("not implemented")
        }
